    ...
    <>
      <section className="site-section story-section reveal" id="story">
        <div className="story-grid">
          ...
          <figure className="story-portrait reveal"><img src="./assets/lyuba-portrait-03.png" alt="Любовь Стёпина на природе" /><div className="story-photo-strip"><img src="./assets/lyuba-portrait-02.png" alt="Любовь Стёпина в лесу" /><img src="./assets/lyuba-portrait-06.png" alt="Любовь Стёпина у маяка" /></div></figure>
        </div>
      </section>
...
function LandingSections() {
  const services = [
    { number: '01', title: 'Натальная карта', text: 'Увидеть таланты, задачи, опоры и направление развития через карту рождения.', price: '4 000 ₽', details: ['Созвон + видеозапись', 'Отношения, карьера, предназначение'] },
    { number: '02', title: 'Годовой прогноз', text: 'Понять ритм предстоящего года и заранее увидеть важные повороты и возможности.', price: '6 500 ₽', details: ['Запись консультации', 'Текстовый материал по итогам'] },
    { number: '03', title: 'Астрология вопроса', text: 'Прашна помогает получить ясность по конкретному вопросу: отношения, работа, решение или покупка.', price: '1 600 ₽', details: ['Чёткий вопрос — конкретный ответ', 'Бесплатный лайт-разбор доступен в боте'] },
    { number: '04', title: 'Ректификация и совместимость', text: 'Уточнить время рождения или посмотреть, как встречаются две карты и два жизненных сценария.', price: 'от 2 500 ₽', details: ['Ректификация — 4 000 ₽', 'Совместимость партнёров — 2 500 ₽'] },
